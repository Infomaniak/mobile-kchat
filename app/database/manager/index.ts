...
class DatabaseManagerSingleton {
    ...
    constructor() {
        ...
        this.serverModels = [
            ...
            CustomEmojiModel,
            ConferenceModel,
            CustomProfileFieldModel,
            ConferenceParticipantModel,
            CustomProfileAttributeModel,
            DraftModel,
            FileModel,
            GroupModel,
            GroupChannelModel,
    ...
    */
    private deleteServerDatabaseFilesByName = async (databaseName: string): Promise<void> => {
        ...
        await deleteFile(databaseFile);
        await deleteFile(databaseShm);
        await deleteFile(databaseWal);
    };
    ...
    */
    private renameDatabase = async (databaseName: string, newDBName: string): Promise<void> => {
        ...
        if (new File(newDatabaseFile).exists) {
