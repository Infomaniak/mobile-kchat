        ...
        expect(serverSchema).toEqual({
            ...
            tables: {
                ...
                [POSTS_IN_CHANNEL]: {
                    ...
                    columns: {
                        channel_id: {name: 'channel_id', type: 'string', isIndexed: true},
                        earliest: {name: 'earliest', type: 'number', isIndexed: true},
                        latest: {name: 'latest', type: 'number', isIndexed: true},
                    },
                    columnArray: [
                        {name: 'channel_id', type: 'string', isIndexed: true},
                ...
                [THREAD]: {
                    ...
                    unsafeSql: undefined,
                    columns: {
                        is_following: {name: 'is_following', type: 'boolean', isIndexed: true},
                        last_reply_at: {name: 'last_reply_at', type: 'number', isIndexed: true},
                        last_viewed_at: {name: 'last_viewed_at', type: 'number'},
                        reply_count: {name: 'reply_count', type: 'number', isIndexed: true},
                        unread_mentions: {name: 'unread_mentions', type: 'number', isIndexed: true},
                        unread_replies: {name: 'unread_replies', type: 'number', isIndexed: true},
                        viewed_at: {name: 'viewed_at', type: 'number'},
                        last_fetched_at: {name: 'last_fetched_at', type: 'number', isIndexed: true},
                    },
                    columnArray: [
