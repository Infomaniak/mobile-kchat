...
/**
  ...
  */
export const transformGroupRecord = ({
    action,
    database,
    value,
}: TransformerArgs<GroupModel, Group>): Promise<GroupModel> => {
    const raw = value.raw;
...
/**
   ...
   */
export const transformGroupChannelRecord = ({
    action,
    database,
    value,
}: TransformerArgs<GroupChannelModel, GroupChannel>): Promise<GroupChannelModel> => {
    const raw = value.raw;
...
/**
   ...
   */
export const transformGroupMembershipRecord = ({
    action,
    database,
    value,
}: TransformerArgs<GroupMembershipModel, GroupMembership>): Promise<GroupMembershipModel> => {
    const raw = value.raw;
...
/**
   ...
   */
export const transformGroupTeamRecord = ({
    action,
    database,
    value,
}: TransformerArgs<GroupTeamModel, GroupTeam>): Promise<GroupTeamModel> => {
    const raw = value.raw;
