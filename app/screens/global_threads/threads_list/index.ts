    ...
    return {
        ...
        threads: teamThreadsSyncObserver.pipe(
            switchMap((teamThreadsSync) => {
                ...
                return queryThreadsInTeam(database, teamId, {onlyUnreads: getOnlyUnreads, hasReplies: true, isFollowing: true, sort: true, earliest, limit: getOnlyUnreads ? 50 : 100}).observe();
            }),
        ),
    };
});
