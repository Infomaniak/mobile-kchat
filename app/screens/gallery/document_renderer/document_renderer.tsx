            ...
            <TouchableWithoutFeedback onPress={handleHideControls}>
                <Animated.View style={styles.container}>
                    ...
                    <View style={{marginTop: 16}}>
                        ...
                        >
                            <View style={buttonBackgroundStyle(Preferences.THEMES.ik, 'lg', 'primary', enabled ? 'default' : 'disabled')}>
                                <Text style={buttonTextStyle(Preferences.THEMES.ik, 'lg', 'primary', enabled ? 'default' : 'disabled')} >{optionText}</Text>
                            </View>
                        </RectButton>
                    </View>
                    }
