...
// describe.skip('EnhancedScheduledPostCoreOptions', () => {
...
//     it.skip('should correctly return the isMilitaryTime preference', async () => {
...
//     it.skip('should return false if the isMilitaryTime preference is not set', async () => {
//         // IK change : skipped on CI temporarily, will fix later
//         await operator.handlePreferences({
//             preferences: [],
//             prepareRecordsOnly: false,
