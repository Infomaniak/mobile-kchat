...
jest.mock('@utils/time', () => ({
    getFormattedTime: jest.fn().mockReturnValue('8:00 AM'),
}));
...
describe('ScheduledPostCoreOptions', () => {
    ...
    it('renders correctly for Sunday', () => {
        ...
        expect(getByText('Tomorrow at 8:00 AM')).toBeTruthy();

        // Should not show Monday or Next Monday options
        expect(queryByText('Monday at 8:00 AM')).toBeNull();
        expect(queryByText('Next Monday at 8:00 AM')).toBeNull();
    ...
    it('renders correctly for Monday', () => {
        ...
        expect(getByText('Tomorrow at 8:00 AM')).toBeTruthy();
        expect(getByText('Next Monday at 8:00 AM')).toBeTruthy();
    ...
    it('renders correctly for Friday', () => {
        ...
        expect(getByText('Monday at 8:00 AM')).toBeTruthy();

        // Should not show Tomorrow or Next Monday options
        expect(queryByText('Tomorrow at 8:00 AM')).toBeNull();
        expect(queryByText('Next Monday at 8:00 AM')).toBeNull();
    ...
    it('calls onSelectOption with correct timestamp when Tomorrow is selected', () => {
        ...
        fireEvent.press(getByText('Tomorrow at 8:00 AM'));
    ...
    it('calls onSelectOption with correct timestamp when Monday is selected', () => {
        ...
        fireEvent.press(getByText('Monday at 8:00 AM'));

        const expectedTime = mockDate.clone().isoWeekday(1).add(1, 'week').startOf('day').hour(8).minute(0);
    ...
    it('calls onSelectOption with correct timestamp when Next Monday is selected', () => {
        ...
        fireEvent.press(getByText('Next Monday at 8:00 AM'));
