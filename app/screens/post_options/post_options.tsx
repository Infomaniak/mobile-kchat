...
const PostOptions = ({
    ...
    const canCopyPermalink = !isSystemPost;
    const canCopyText = canCopyPermalink && Boolean(post.message);
    ...
    const snapPoints = useMemo(() => {
        ...
        return items;
    }, [canCopyPermalink, canReply, canCopyText, canDelete, canEdit, canMarkAsUnread, canPin, isSystemPost, shouldRenderAi, shouldRenderFollow, canShowReminder, canTranslate, canViewTranslation, shouldShowBindings, canAddReaction]);
