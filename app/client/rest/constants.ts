...
// Staging
// export const BASE_SERVER_URL = 'https://infomaniak.kchat.staging-74314.dev.infomaniak.ch';
// export const BASE_LOGIN_URL = 'https://login.staging-74314.dev.infomaniak.ch';
